...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The turns were not being managed correctly.
    ...
    // Defect(s) Found: players with 1 turn do not return to the queue correctly
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: players with infinite turns do not stay in the queue
    ...
    // Defect(s) Found: players with negative turns do not stay in the queue correctly
